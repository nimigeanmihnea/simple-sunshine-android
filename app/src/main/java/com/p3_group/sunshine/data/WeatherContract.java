...
public class WeatherContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.p3_group.sunshine.app";
    ...
    public static final class LocationEntry implements BaseColumns{
        ...
        public static final Uri CONTENT_URI =
                BASE_CONTENT_URI.buildUpon().appendPath(PATH_LOCATION)
                .build();
    ...
    public static final class WeatherEntry implements BaseColumns{
        ...
        public static final Uri CONTENT_URI =
                BASE_CONTENT_URI.buildUpon().appendPath(PATH_WEATHER)
                .build();
        ...
        public static Uri buildWeatherLocationWithDate(String locationSetting, long date) {
            return CONTENT_URI.buildUpon().appendPath(locationSetting)
                    .appendQueryParameter(COLUMN_DATE, normalizeDate(date)).build();
        }
